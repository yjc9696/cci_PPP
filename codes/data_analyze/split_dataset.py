...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_dir", type=str, default='mouse_small_intestine3',
    ...
    parser.add_argument("--ligand_receptor_gene", type=str, default='mouse_ligand_receptor_pair.csv',
                        help="cluster - cluster interaction depleted")
    parser.add_argument("--train_cluster", nargs='+', type=int, default=[2, 3, 4, 5, 11, 13, 14, 15],
                        help="cluster used to train bone marrow")
    parser.add_argument("--test_cluster", nargs='+', type=int, default=[1, 6, 7, 8, 9, 10, 12, 16],
                        help="cluster used to test bone marrow")
