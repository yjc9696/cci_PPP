...
def generate_gt(clusters, dataset):
    cci_labels_depleted_path = '{}/mouse_small_intestine_1189_cci_labels_junk_{}_{}.csv'
    ...
    cci_path = 'mouse_small_intestine_1189_cluster_cluster_interaction_depleted.csv'
    ...
    for m in range(len(cci)):
        ...
        for i in range(len(df1)):
            for j in range(len(df2)):
                ...
                pair1 = pair1.drop(['type', 'id'])
                pair2 = pair2.drop(['type', 'id'])
        ...
        with open(cci_labels_depleted_path.format(dataset, type1, type2), 'w', encoding='utf-8') as f:
...
if __name__ == "__main__":
    ...
    # test_dataset
    print('begin test 4 depleted cluster generate:')
    generate_gt(test_cluster, dataset='test_dataset4_depleted')

    # train_dataset
    print('begin train 4 depleted cluster generate:')
    generate_gt(train_cluster, dataset='train_dataset4_depleted')
    ...
    # test_dataset
    print('begin test 3 depleted cluster generate:')
    generate_gt(test_cluster, dataset='test_dataset3_depleted')

    # # # train_dataset
    print('begin train 3 depleted cluster generate:')
    generate_gt(train_cluster, dataset='train_dataset3_depleted')
