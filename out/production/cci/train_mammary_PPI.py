...
# self-defined
from datasets import load_PPI_mammary_gland, load_tissue, TrainSet
...
class Trainer:
    def __init__(self, params):
        ...
        self.train_mask, self.vali_mask, self.test_dataset = load_PPI_mammary_gland(params)
...
if __name__ == '__main__':
    """
    python ./code/train_mammary.py --dataset 1189 --tissue blood
