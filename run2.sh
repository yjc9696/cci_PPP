...
python codes/data_analyze/all_pairs.py --data_dir mouse_small_intestine2 --dataset train_dataset
python codes/data_analyze/all_pairs.py --data_dir mouse_small_intestine2 --dataset test_dataset